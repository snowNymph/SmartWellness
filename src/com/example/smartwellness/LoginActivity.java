...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ToKeepVar.getInstance().setNetworkStatus(isOnline());
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			if(ToKeepVar.getInstance().getNetworkStatus()){
	...
	public class UserLoginTask extends AsyncTask<Void, Void, String> {
		...
		protected String doInBackground(Void... params) {
			...
			if( loginPost.getStr().equals("fail") )
				return null;
			else
			{
				...
				memberList.put("condition", "trainer_uid=" + loginPost.getStr());
				JsonRequestPost list = new JsonRequestPost(memberList, ConstantVar.URL + ConstantVar.SELECT);
				
				list.requestPost();
				ToKeepVar.getInstance().settest(list.getStr());
	...
	public void taskFunc(String data)
	{
		ToKeepVar.getInstance().setData(data);
